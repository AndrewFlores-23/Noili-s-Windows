      ...
      <section className="projects-gallery page-shell">
        {projects.map((project, index) => (
          <article className={`gallery-project gallery-project-${(index % 3) + 1}`} key={project.title}>
            <div className="gallery-image"><img src={project.image} alt={project.alt} loading={index < 2 ? 'eager' : 'lazy'} /><span className="real-badge glass-panel">Proyecto real</span></div>
