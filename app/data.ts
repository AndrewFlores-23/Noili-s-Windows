...
export const catalogItems: CatalogItem[] = [
  ...
  },
  {
    ...
    image: asset('/media/project-living.png'),
    alt: 'Paneles enrollables en una sala contemporánea',
    note: 'Luz de día y privacidad de noche.',
  },
  {
  ...
  },
  {
    ...
    image: asset('/media/catalog-furniture.webp'),
    alt: 'Sala de formas redondeadas con cenefa tapizada',
...
export const projects = [
  ...
  { title: 'Un acento personal', type: 'Suite · Textiles', image: asset('/media/project-suite-lilac.png'), alt: 'Suite con muebles y textiles color lavanda' },
