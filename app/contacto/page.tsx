    ...
    <main>
      ...
      <section className="contact-hero">
        ...
        <div className="page-shell contact-hero-inner">
          ...
          <div className="contact-card glass-panel"><p className="kicker kicker-light">Contacto directo</p><a className="contact-main-link" href="https://wa.me/50689760770" target="_blank" rel="noreferrer"><span>WhatsApp</span><strong>+506 8976-0770</strong><b><ArrowIcon /></b></a><a className="contact-main-link" href="tel:+50626536434"><span>Teléfono</span><strong>+506 2653-6434</strong><b><ArrowIcon /></b></a><a className="contact-main-link" href="mailto:noilyswindowtreatment@gmail.com"><span>Correo</span><strong>noilyswindowtreatment@gmail.com</strong><b><ArrowIcon /></b></a></div>
        </div>
      </section>
      <section className="locations-section page-shell">
        ...
        <div className="location-grid"><article className="glass-panel"><span>01</span><h3>Las Catalinas</h3><p>Pueblo de Las Catalinas<br />Edificio Central, Calle La Ronda<br />Local 17121</p><a href="https://maps.google.com/?q=Pueblo+de+Las+Catalinas+Guanacaste" target="_blank" rel="noreferrer">Abrir mapa <ArrowIcon /></a></article><article className="glass-panel"><span>02</span><h3>Huacas</h3><p>Centro Comercial Paseo del Mar<br />Local 03–1A<br />Guanacaste, Costa Rica</p><a href="https://maps.google.com/?q=Centro+Comercial+Paseo+del+Mar+Huacas+Guanacaste" target="_blank" rel="noreferrer">Abrir mapa <ArrowIcon /></a></article></div>
        <div className="secondary-contact"><span>Correo alternativo</span><a href="mailto:noily.campos@gmail.com">noily.campos@gmail.com</a><a href="https://www.instagram.com/noilyswindows/" target="_blank" rel="noreferrer">@noilyswindows <ArrowIcon /></a></div>
      </section>
      <SiteFooter />
    </main>
  );
